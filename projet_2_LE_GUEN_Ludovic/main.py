...
CHEMIN_MODULE_DATA = r"C:\Users\crypt\Desktop\openclassroom\module_2\virtual_env\data"
CHEMIN_LOG = (
    "C:\\Users\crypt\Desktop\openclassroom\module_2\virtual_env\datajournal_logging.log"
)
    ...
    if "text/html" in ct:
        ...
        for categorie in liste_nom_category:
            ...
            with open(path_clean, "w") as fichier:
                initialisation = csv.writer(fichier, delimiter="|")
                initialisation.writerow(liste_header)
